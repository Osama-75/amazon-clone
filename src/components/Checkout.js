    ...
    return (
        <div className="h-screen bg-amazonclone-background">
            <div className="min-w-[1000px] max-w-[1500px] m-auto pt-8">
                <div className="grid grid-cols-8 gap-10 max-lg:grid-cols-6">
                    {/* Products */}
                    <div className="col-span-6 bg-white max-lg:col-span-4">
                            ...
                            return (
                                <div key={product.id}>
                                    <div className="grid grid-cols-12 divide-y divide-gray-400 mr-4">
                                        <div className="col-span-10 grid grid-cols-8 divide-y divide-gray-400 max-sm:divide-y-0">
                                        ...
                                        <div className="col-span-2 max-sm:col-span-6">
                                            <div className="text-lg xl:text-xl mt-2 mr-4 font-semibold max-sm:ml-4">
                    ...
                    {/* Checkout */}
                    <div className="col-span-2 bg-white rounded h-[250px] p-7 max-lg:col-span-4">
                        ...
                        <button className="btn w-1/2">Proceed to Checkout</button>
                    </div>
                </div>
            </div>
        </div>
